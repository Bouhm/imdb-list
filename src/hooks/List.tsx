...
// Memoized version that will delete an item without re-rendering the whole list
const ListItem = memo(function ({ id, title, vote_average, overview, release_date, genres, onDeleteMovie, index }: ListItemProps) {
  return (
    <div key={`${index}__${id}`} className="list-item">
      <div className="list-item-buttons">
        <span onClick={function () { onDeleteMovie(id); }}>
